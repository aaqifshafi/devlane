    ...
    <div className="container mx-auto p-2 w-[600px] text-slate-700 flex justify-between">
      ...
      <div className="flex flex-col gap-2 items-end">
          <div className="flex gap-3 h-[24px]">
            <a><img src="https://img.icons8.com/?size=100&id=32309&format=png&color=000000" width="20px"></img></a>
            <a><img src="https://img.icons8.com/?size=100&id=8808&format=png&color=000000" width="20px"></img></a>
            <a><img src="https://img.icons8.com/?size=100&id=37326&format=png&color=000000" width="20px"></img></a>
          </div>
